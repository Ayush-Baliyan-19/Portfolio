...
const ExpCard: React.FC<ModalInterface> = ({
  ...
  return (
    <>
      <div className="relative right-8 my-5 flex w-[93vw] text-xs lg:w-full">
        <Image
          data-aos="zoom-in"
        ...
        <div
          data-aos="fade-left"
          data-aos-anchor-placement="top-bottom"
          className="ml-3 flex w-10/12 flex-col rounded-xl bg-[#d8d8d8] px-2 py-4 lg:px-6 dark:bg-[#262627]"
        >
